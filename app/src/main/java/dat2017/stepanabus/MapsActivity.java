...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    //LatLng stop1= new LatLng(39.826299, 46.765397);
    //LatLng stop2= new LatLng(39.823992, 46.763702);
...
// go to the settings
    ...
    /*  int col1 = getResources().getColor(R.color.darkgreen);
        int col2 = getResources().getColor(R.color.darkred);
        int col3 = getResources().getColor(R.color.darkblue);
        int col4 = getResources().getColor(R.color.darkorange);
        int col5 = getResources().getColor(R.color.darkpurple);
        int col6 = getResources().getColor(R.color.darkgreen);
        int col7 = getResources().getColor(R.color.darkred);
        int col8 = getResources().getColor(R.color.darkblue);
        int col9 = getResources().getColor(R.color.darkorange);
        int col10 = getResources().getColor(R.color.darkpurple);
    */

       /* String languageToLoad = "hy_";
    ...
    private void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(stepanakert).title("Stepanakert"));
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in Stepanakert and move the camera
        //LatLng stepanakert = new LatLng(39.8177000, 46.7528000);
